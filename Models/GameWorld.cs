...
public class GameWorld
{
    ...
    public Dictionary<string, LockedDoor> LockedDoors { get; set; } = new();
    public Dictionary<string, RoomDoor> Doors { get; set; } = new();
    public Dictionary<string, RevivalAltar> RevivalAltars { get; set; } = new();
